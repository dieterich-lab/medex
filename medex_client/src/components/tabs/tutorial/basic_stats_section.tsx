...
function BasicStatsSection() {
    return (
        <TSection headline="Basic Stats">
            <div className="row">
                <TText>
                    The Basic Stats consist of multiple tabs. The first one display general information
                    about the database as a whole. This statistics don&#39;t consider filtering.
                </TText>
            ...
            <div className="row">
                <TText>
                    ...
                    <p>
                        For other types of entities only the number of patients, for which the
