        ...
        <div>
            ...
            <div className="rangs-slider-extra-controls">
                ...
                <MyTextInput
                    ...
                    on_blur={(x) => on_blur(props, {from_value: x, to_value: text_field_state.to_value}, ValueType.From)}
                />
                &nbsp;to&nbsp;
                <MyTextInput
                    {...props}
                    ...
                    on_blur={(x) => on_blur(props, {from_value: text_field_state.from_value, to_value: x}, ValueType.To)}
                />
            </div>
        </div>
    );
