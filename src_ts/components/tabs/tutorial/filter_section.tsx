    ...
    return (
        <TSection headline="Patient Filter">
            <div className="row">
                ...
                <TText>
                    A entity may be selected from a drop down menu. In some datasets thousands of diffrent entties may
            ...
            <div className="row">
                <TText>
                    ...
                    slider or by entering values in the 'from' and 'to' fields. After applying
                ...
                <TText>
                    ...
                    filter conditions will be included (logical 'and' operation). The
