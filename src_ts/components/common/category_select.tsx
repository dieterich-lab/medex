...
import {get_options_from_strings, TypedMultiSelectProps} from '../../utility/selection';

interface CategorySelectorProps extends TypedMultiSelectProps<string> {
    entity: Entity | null;
}
...
function CategorySelect(props: CategorySelectorProps) {
    ...
    const options = props.entity?.categories == null || props.entity.categories.length == 0 ?
