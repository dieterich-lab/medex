...
import {TypedSingleSelectProps} from "../../utility/selection";
...
function SingleMeasurementSelect(props: TypedSingleSelectProps<string>) {
    const [state, set_state] = useState<MeasurementSelectionState|null>(null);
    useEffect(() => populate_measurement_selection_state(set_state, state, false), []);
